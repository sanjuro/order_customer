package com.vosto.customer.favourites;
...
public class ProductFavouriteListAdapter extends ArrayAdapter<ProductVo>{

    Context context;
    int layoutResourceId;
    ProductVo[] products = null;

    public ProductFavouriteListAdapter(Context context, int layoutResourceId, ProductVo[] products) {
