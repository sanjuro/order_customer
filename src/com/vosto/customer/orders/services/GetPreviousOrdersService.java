...
public class GetPreviousOrdersService extends RestService {
	...
	public GetPreviousOrdersService(OnRestReturn listener, VostoBaseActivity context){
		super("http://107.22.211.58:9000/api/v1/orders/page/1?authentication_token=" + context.getAuthenticationToken(), RequestMethod.GET, ResultType.GET_PREVIOUS_ORDERS, listener, context);
	...
	public GetPreviousOrdersService(OnRestReturn listener, VostoBaseActivity context, int page){
		super("http://107.22.211.58:9000/api/v1/orders/page/" + page + "?authentication_token=" + context.getAuthenticationToken(), RequestMethod.GET, ResultType.GET_PREVIOUS_ORDERS, listener, context);
	}
